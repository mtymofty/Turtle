...
export class ErrorUtils {
    static error_mess: Record<ErrorType, string> = {
        ...
        [ErrorType.ARGS_NUM_ERR]: `CRITICAL ERROR - FUNCTION "$" TAKES EXACTLY $ ARGUMENTS, $ WERE GIVEN`,
        ...
        [ErrorType.NEG_TYPE_ERR]: `CRITICAL ERROR - NEGATION IS NOT SUPPORTED FOR TYPES $ AND $`,
        [ErrorType.LOG_NEG_TYPE_ERR]: `CRITICAL ERROR - LOGICAL NEGATION IS NOT SUPPORTED FOR TYPES $ AND $`,
