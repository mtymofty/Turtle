...
export class ErrorUtils {
    static error_mess: Record<ErrorType, string> = {
        ...
        [ErrorType.AND_TYPE_ERR]: `CRITICAL ERROR - CONJUNCTION IS NOT SUPPORTED FOR TYPES $ AND $`,
        ...
        [ErrorType.BREAK_CONT_ERR]: `CRITICAL ERROR - BREAK AND CONTINUE STATEMENT ARE ONLY LEGAL INSIDE A LOOP`,
        [ErrorType.OBJ_PROP_ERR]: `CRITICAL ERROR - PROPERTY '$' DOESN'T EXIST ON TYPE '$'`,
        [ErrorType.OBJ_METH_ERR]: `CRITICAL ERROR - METHOD '$' DOESN'T EXIST ON TYPE '$'`,
        [ErrorType.OBJ_MEM_ACC_ERR]: `CRITICAL ERROR - PRIMITIVE OBJECT TYPE '$' DOESN'T HAVE ANY PROPERTIES`,
        [ErrorType.OBJ_METH_CALL_ERR]: `CRITICAL ERROR - PRIMITIVE OBJECT TYPE '$' DOESN'T HAVE ANY METHODS`,
        [ErrorType.OBJ_ASSIGN_ERR]: `CRITICAL ERROR - EXPECTED TYPE '$' IN '$' PROPERTY ASSIGNMENT. GOT ARGUMENT OF TYPE '$'`,
        [ErrorType.BUILDIN_FUN_REDEF_ERR]: `CRITICAL ERROR - ENCOUNTERED REDEFINITION OF BUILTIN FUNCTION $!`,
        [ErrorType.RECUR_CONTEXT_ERR]: `CRITICAL ERROR - EXCEEDED FUNCALL RECURSION LIMIT (100)!`,
        [ErrorType.RECUR_SCOPE_ERR]: `CRITICAL ERROR - EXCEEDED SCOPE NESTING LIMIT (100)!`,
        [ErrorType.BUILDIN_CONST_REDEF_ERR]: `CRITICAL ERROR - ENCOUNTERED REDEFINITION OF BUILTIN CONSTRUCTOR $!`
    }
    ...
    static warning_mess: Record<WarningType, string> = {
        ...
        [WarningType.INT_OVERFLOW_WARN]: "WARNING - ENCOUNTERED INT OVERFLOW! SETTING TO MAX INTEGER VALUE.",
        [WarningType.DOUBLE_OVERFLOW_WARN]: "WARNING - ENCOUNTERED DOUBLE OVERFLOW! SETTING TO MAX DOUBLE VALUE.",
        [WarningType.POS_WARN]: "WARNING - $ POSITION EXCEEDED VALUE LIMIT (0-500). SETTING TO $",
    }
}
